  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      <Route path="/" element={<RootLayout />}>
        ...
        <Route path="work2025" element={<Work2025 />} />
        <Route path="work2024" element={<Work2024 />} />
        <Route path="work2023" element={<Work2023 />} />
        <Route path="work2022" element={<Work2022 />} />
        <Route path="work2021" element={<Work2021 />} />
        <Route path="work2020" element={<Work2020 />} />
        <Route path="work2019" element={<Work2019 />} />
