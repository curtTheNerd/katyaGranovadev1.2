  ...
  return (
    <div className="flex-center flex-col w-[90%] md:w-[80%] max-w-[1440px] m-auto pb-20">
      ...
      <p className="w-full">
        ...
        (Shtager Gallery, 2023); When My Babushka Joined the Reich (Barbican Art
        Group Trust, 2022); and A Song of Unrequited Love for Britain
        ...
        Art Prize (2023), Art Works Open (2021), and Signature Art Prize (2020);
        she was a finalist for the Castlegate Art Prize (2020) and the Women
        United Art Prize (2023), received shortlist recognition for the Bankley
        Prize (2019), and was longlisted for both the Contemporary British
        Painting Prize (2023) and the John Moores Painting Prize (2020). In
        2020, she collaborated with Burberry UK, and in 2021 her work entered
        the permanent collection of the Royal College of Art.
      </p>
